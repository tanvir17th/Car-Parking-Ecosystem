...
namespace Car_Parking_Ecosystem
{
    ...
    {
        SqlConnection connect = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\HP\Documents\carparking.mdf;Integrated Security=True;Connect Timeout=30");
