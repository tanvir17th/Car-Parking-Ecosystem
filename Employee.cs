...
namespace Car_Parking_Ecosystem
{
    ...
    {
        string connectionString = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\HP\Documents\carparking.mdf;Integrated Security=True;Connect Timeout=30";
        public Employee()
        {
            InitializeComponent();
        }
