...
namespace Car_Parking_Ecosystem
{
    ...
    {
        private string connectionString = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\HP\Documents\carparking.mdf;Integrated Security=True;Connect Timeout=30";
