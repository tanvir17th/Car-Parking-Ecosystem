...
namespace Car_Parking_Ecosystem
{
    public partial class Customer : Form
    {
        ...
        private void Customer_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                using (SqlConnection connection = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\HP\Documents\carparking.mdf;Integrated Security=True;Connect Timeout=30"))
                {
                    connection.Open();
        ...
        private void RefreshChart()
        {
            try
            {
                using (SqlConnection con = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\HP\Documents\carparking.mdf;Integrated Security=True;Connect Timeout=30"))
                {
                    con.Open();
